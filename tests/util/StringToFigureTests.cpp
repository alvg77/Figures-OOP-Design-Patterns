...
TEST_CASE("StringToFigure::create_figure throws on invalid parameter count", "[StringToFigure]") {
    SECTION("triangle with too few parameters") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("triangle 3.0 4.0"),
    ...
    SECTION("triangle with too many parameters") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("triangle 3.0 4.0 5.0 6.0"),
            std::invalid_argument
        );
        REQUIRE_THROWS_WITH(
            StringToFigure::create_figure("triangle 3.0 4.0 5.0 6.0"),
    ...
    SECTION("circle with too few parameters") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("circle"),
            std::invalid_argument
        );
        REQUIRE_THROWS_WITH(
            StringToFigure::create_figure("circle"),
            "circle requires one parameter"
        );
    }

    SECTION("circle with too many parameters") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("circle 5.0 6.0"),
            std::invalid_argument
        );
        REQUIRE_THROWS_WITH(
            StringToFigure::create_figure("circle 5.0 6.0"),
    ...
    SECTION("rectangle with too few parameters") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("rectangle 4.0"),
            std::invalid_argument
        );
        REQUIRE_THROWS_WITH(
            StringToFigure::create_figure("rectangle 4.0"),
    ...
    SECTION("rectangle with too many parameters") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("rectangle 4.0 6.0 8.0"),
            std::invalid_argument
        );
        REQUIRE_THROWS_WITH(
            StringToFigure::create_figure("rectangle 4.0 6.0 8.0"),
...
TEST_CASE("StringToFigure::create_figure throws on invalid figure name", "[StringToFigure]") {
    SECTION("unknown figure name") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("square 5.0"),
            std::invalid_argument
        );
        REQUIRE_THROWS_WITH(
            StringToFigure::create_figure("square 5.0"),
            "Invalid figure string"
        );
    }

    SECTION("empty string") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure(""),
            std::invalid_argument
        );
    }
    ...
    SECTION("gibberish") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("asdfghjkl 1 2 3"),
            std::invalid_argument
        );
    }
}
...
TEST_CASE("StringToFigure::create_figure throws on invalid numeric parameters", "[StringToFigure]") {
    SECTION("non-numeric parameter for triangle") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("triangle 3.0 abc 5.0"),
            std::invalid_argument
        );
    }
    ...
    SECTION("non-numeric parameter for circle") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("circle xyz"),
            std::invalid_argument
        );
    }
    ...
    SECTION("non-numeric parameter for rectangle") {
        REQUIRE_THROWS_AS(
            StringToFigure::create_figure("rectangle 4.0 notanumber"),
            std::invalid_argument
        );
    }
}
